...
class MY_Model extends CI_Model
{
    ...
    public function _prep_after_read($data, $multi = TRUE)
    {
        ...
        if(isset($this->return_as_dropdown) && $this->return_as_dropdown == 'dropdown')
        {
            foreach($data as $row)
            {
                $dropdown[$row[$this->primary_key]] =  $row[$this->_dropdown_field].' - '.$row[$this->_dropdown_field2];
            }
            $data = $dropdown;
    ...
    public function as_dropdown($field = NULL, $field2 = NULL)
    {
        if(!isset($field))
        {
        ...
        $this->_dropdown_field2 = $field2;
        $this->_select = array($this->primary_key, $field, $field2);
        return $this;
    }
